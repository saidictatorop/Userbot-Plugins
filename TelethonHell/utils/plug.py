...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        LOGS.info("⚡ ʀᴀᴅʜᴀᴜꜱᴇʀʙᴏᴛ ⚡ - Successfully Imported " + shortname)
...
async def plug_channel(client, channel):
    if channel != 0:
        LOGS.info("⚡ ʀᴀᴅʜᴀᴜꜱᴇʀʙᴏᴛ ⚡ - PLUGIN CHANNEL DETECTED.")
        LOGS.info("⚡ ʀᴀᴅʜᴀᴜꜱᴇʀʙᴏᴛ ⚡ - Starting to load extra plugins.")
